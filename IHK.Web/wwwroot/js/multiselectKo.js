...
!function ($) {
    ...
    //            if (options.length === 0) {
    //                return '<b class="caret"></b>&nbsp&nbsp&nbsp' + this.nonSelectedText;
    //            }
    //            else {
    //                if (options.length > this.numberDisplayed) {
    //                    return '<b class="caret"></b>&nbsp&nbsp&nbsp' + options.length + ' ' + this.nSelectedText;
    //                }
    //                else {
    //                    var selected = '';
    ...
    //                        selected += label + ', ';
    //                    });
    //                    return '<b class="caret"></b>&nbsp&nbsp&nbsp' + selected.substr(0, selected.length - 2);
    //                }
    //            }
    //        },
    //        /**
    ...
    //    templates: {
    //        button: '<button type="button" class="multiselect form-control dropdown-toggle" style="text-align: left;" data-toggle="dropdown"></button>',
